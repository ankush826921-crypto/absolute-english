(function () {
    ...
    document.addEventListener("DOMContentLoaded", async () => {
        ...
        try {
            ...
            document.title = `${t.name} | Lingua Academy`;

            content.innerHTML = `
                <section class="faculty-profile-hero">
                    <div class="faculty-profile-hero__image">
                        <img src="${t.image}" alt="${t.name}, ${t.designation}">
                    </div>

                    <div>
                        <p class="faculty-eyebrow">${t.language} faculty</p>

                        <h1>${t.name}</h1>

                        <p class="faculty-profile-hero__designation">
                            ${t.designation}
                        </p>
                        ...
                        <div class="faculty-profile-metrics">
                            ...
                            <span>${t.students.toLocaleString()}+ students taught</span>
                ...
                <section class="faculty-profile-grid">
                    ...
                    <article class="faculty-profile-panel faculty-profile-panel--bio">
            ...
            content.querySelector("img").addEventListener("error", (e) => {
                e.currentTarget.src =
                    "https://placehold.co/500x500/e0e7ff/172554?text=Lingua+Academy";
            });
